"""
Zappos.com Scraper – scrapes real fashion products from zappos.com
Uses JSON-LD structured data embedded in search/category result pages.
Each category page provides ~100 products with full schema.org Product data.
"""
    ...
    def _parse_jsonld(self, html: str, label: str, cat_hint: str = "") -> list[ScrapedProduct]:
        ...
        for script in ld_scripts:
            try:
                ...
                logger.debug(f"[Zappos] Skipping JSON-LD parse error: {e}")
